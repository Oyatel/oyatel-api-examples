...
Oyatel = function() {
	...
	var _cometdServerUri = 'https://api.oyatel.com:443/cometd/';
		...
		User: function() {
			return {
				currentUser: function(cb) {
					...
					_performRestRequest('https://evendev.oyatel.com/rest/account/me.json', null, cb);
				}
			}
		}(),
		Voicemail: function() {
			return {
				mailbox: function(cb) {
					_performRestRequest('https://evendev.oyatel.com/rest/voicemail/mailboxForUser/', null, cb);
				},
				getMessages: function(vboxId, cb) {
					_performRestRequest('https://evendev.oyatel.com/rest/voicemail/getMessages/' + vboxId + '.json', null, cb);	
				},
				getMessageRecordingURL: function(messageId, format) {
					var format = format || 'wav';
					return _getRestRequestUri('https://evendev.oyatel.com/rest/voicemail/getMessageRecording/' + messageId + '.' + format + '/');
				}
			}
		}(),
		Queue: function() {
			return {
				...
				getQueues: function(cb) {
					_performRestRequest('https://evendev.oyatel.com/rest/queue/getQueues.json', null, cb);
				}
			}
		}(),
		Call: function() {
			return {
				callback: function(params, cb) {
					...
					_performRestRequest('https://evendev.oyatel.com/rest/call/callback.json', params, cb);
				},
